...
class UsesCase extends BaseController
{
    private $dataToView;
	private $dataToMenu;
...
// obtener listado casos de uso
		$getUsesCase = new GetListUsesCase();
		$this->dataToView['usesCase'] = $getUsesCase();
		$this->renderView();
	}
	...
	private function renderView()
	{
        ...
        echo view('usescase', $this->dataToView);
