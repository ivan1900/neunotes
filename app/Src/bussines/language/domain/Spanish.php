...
class Spanish 
{
    ...
    public function __construct()
    {
        $this->langMap = [
            ...
            'messageSuccesDelete' => 'Se ha eliminado',
            'messageSuccesSave' => 'Se ha guardado',
            'messageFailDelete' => 'No se ha podido eliminar',
            'messageFailSave' => 'No se ha podido guardar, revise los campos',
            'name' => 'Nombre',
            'no' => 'No',
            'notes' => 'Notas',
            'nuevo'=> 'Nuevo',
