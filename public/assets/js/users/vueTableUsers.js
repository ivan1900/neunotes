...
var vuetableusers = ({
    ...
    <div>
        ...
        <a slot="active" slot-scope="props" v-if="props.row.active == 0" class=".btn-circle fa fa-times"></a>
            <a slot="active" slot-scope="props" v-else class=".btn-circle fa fa-check"></a>
